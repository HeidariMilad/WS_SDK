 ...
 */
const DEFAULT_HOVER_OPTIONS: Required<HoverOptions> = {
 ...
 */
const activeHovers = new WeakMap<Element, number>();
...
export async function handleHover(
  ...
  const options = (data.options as Partial<HoverOptions>) || {};
  const config: Required<HoverOptions> = {
  ...
  try {
    ...
    const MouseEventConstructor = typeof MouseEvent !== 'undefined' ? MouseEvent : (globalThis as unknown as { window?: { MouseEvent?: typeof MouseEvent } }).window?.MouseEvent;
