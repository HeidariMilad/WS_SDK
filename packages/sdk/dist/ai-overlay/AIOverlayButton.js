...
exports.createAIOverlayButton = createAIOverlayButton;
 ...
 */
function createAIOverlayButton(options, metadata, onClick) {
    const button = document.createElement("button");
    // Apply base styles
    applyBaseStyles(button, options);
    // Set ARIA attributes
    button.setAttribute("aria-label", options.ariaLabel || options.label || "AI Assistant");
    ...
    // Add icon
    const icon = options.icon || (0, utils_1.getDefaultAiIcon)();
...
function ensureButtonStyles(reducedMotion) {
    if (stylesInjected)
        return;
...
//# sourceMappingURL=AIOverlayButton.js.map